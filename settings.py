...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'proyecto', 'templates')],  # opcional
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# NOTAS:
# - Para desarrollo local crea un archivo `.env` en la carpeta raíz
#   (no lo subas al control de versiones). Puedes usar el archivo
#   `.env.example` creado en este commit como plantilla.
